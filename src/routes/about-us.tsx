...
export const Route = createFileRoute("/about-us")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://dubai-yachts.ae/about-us/" },
    ],
    links: [
      { rel: "canonical", href: "https://dubai-yachts.ae/about-us/" },
      { rel: "alternate", hrefLang: "en", href: "https://dubai-yachts.ae/about-us/" },
      { rel: "alternate", hrefLang: "x-default", href: "https://dubai-yachts.ae/about-us/" },
    ],
  }),
  component: About,
});
