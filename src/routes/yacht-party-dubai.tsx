...
export const Route = createFileRoute("/yacht-party-dubai")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://dubai-yachts.ae/yacht-party-dubai/" },
    ],
    links: [
      { rel: "canonical", href: "https://dubai-yachts.ae/yacht-party-dubai/" },
      { rel: "alternate", hrefLang: "en", href: "https://dubai-yachts.ae/yacht-party-dubai/" },
      { rel: "alternate", hrefLang: "x-default", href: "https://dubai-yachts.ae/yacht-party-dubai/" },
    ],
    scripts: [
      faqSchema(partyFaqs),
      breadcrumbSchema([
        { name: "Home", url: "https://dubai-yachts.ae/" },
        { name: "Yacht Parties", url: "https://dubai-yachts.ae/yacht-party-dubai/" },
      ]),
    ],
  }),
  component: Parties,
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 md:py-24">
        <SectionHeading
          title="Frequently Asked Questions About Yacht Party in Dubai"
