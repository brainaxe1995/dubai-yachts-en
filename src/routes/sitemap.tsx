...
export const Route = createFileRoute("/sitemap")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://dubai-yachts.ae/sitemap/" },
    ],
    links: [
      { rel: "canonical", href: "https://dubai-yachts.ae/sitemap/" },
      { rel: "alternate", hrefLang: "en", href: "https://dubai-yachts.ae/sitemap/" },
      { rel: "alternate", hrefLang: "x-default", href: "https://dubai-yachts.ae/sitemap/" },
    ],
  }),
  component: Sitemap,
});
