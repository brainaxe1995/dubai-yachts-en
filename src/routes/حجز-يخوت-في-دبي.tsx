...
export const Route = createFileRoute("/حجز-يخوت-في-دبي")({
  head: () => ({
    ...
    links: [
      { rel: "canonical", href: "https://doc-whisperer-750.lovable.app/حجز-يخوت-في-دبي" },
      { rel: "alternate", hreflang: "ar", href: "https://doc-whisperer-750.lovable.app/حجز-يخوت-في-دبي" },
      { rel: "alternate", hreflang: "x-default", href: "https://doc-whisperer-750.lovable.app/حجز-يخوت-في-دبي" },
    ],
  }),
