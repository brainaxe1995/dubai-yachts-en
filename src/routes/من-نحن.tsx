        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          <Reveal delay={120}>
            ...
            <p className="mt-4 text-sm leading-loose text-muted-foreground md:text-base">
              ...
              2018، وتوفر أسطولًا متنوعًا من اليخوت لتلبية الرحلات البحرية الخاصة، الرحلات العائلية، الحفلات والمناسبات،
              ورحلات الصيد.
            </p>
            <p className="mt-3 text-sm leading-loose text-muted-foreground md:text-base">
              نحرص على تقديم تجربة بحرية آمنة ومريحة مع <strong>طاقم محترف</strong>، وأسعار واضحة وتفاصيل كاملة قبل كل
              رحلة. كما يتوفر فريقنا على مدار الساعة لمساعدتك في اختيار اليخت والباقة المناسبة والاستمتاع برحلتك في دبي
