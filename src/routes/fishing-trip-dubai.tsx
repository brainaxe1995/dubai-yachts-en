...
export const Route = createFileRoute("/fishing-trip-dubai")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://dubai-yachts.ae/fishing-trip-dubai/" },
    ],
    links: [
      { rel: "canonical", href: "https://dubai-yachts.ae/fishing-trip-dubai/" },
      { rel: "alternate", hrefLang: "en", href: "https://dubai-yachts.ae/fishing-trip-dubai/" },
      { rel: "alternate", hrefLang: "x-default", href: "https://dubai-yachts.ae/fishing-trip-dubai/" },
    ],
  }),
  component: Fishing,
});
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 md:pb-24">
        <SectionHeading
          title="Frequently Asked Questions About Fishing Trip in Dubai"
