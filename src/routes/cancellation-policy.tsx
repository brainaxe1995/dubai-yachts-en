...
export const Route = createFileRoute("/cancellation-policy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://dubai-yachts.ae/cancellation-policy/" },
    ],
    links: [
      { rel: "canonical", href: "https://dubai-yachts.ae/cancellation-policy/" },
      { rel: "alternate", hrefLang: "en", href: "https://dubai-yachts.ae/cancellation-policy/" },
      { rel: "alternate", hrefLang: "x-default", href: "https://dubai-yachts.ae/cancellation-policy/" },
    ],
  }),
  component: Page,
});
